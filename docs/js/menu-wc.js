...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ng-strapi</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter modules">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            <li class="link">
                                <a href="modules/NgStrapiModule.html" data-type="entity-link">NgStrapiModule</a>
                            </li>
                </ul>
                </li>
                        <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/CookieConfig.html" data-type="entity-link">CookieConfig</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/File.html" data-type="entity-link">File</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/LocalStorageConfig.html" data-type="entity-link">LocalStorageConfig</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/ProviderToken.html" data-type="entity-link">ProviderToken</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/StoreConfig.html" data-type="entity-link">StoreConfig</a>
                            </li>
                        </ul>
                    </li>
                    <li class="chapter">
